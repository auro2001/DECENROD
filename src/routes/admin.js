    ...
    addremoveAdmin=(owner,account)=>{
        return (
            <Box mt={2}>
                ...
                <div className="contract-details" style={{marginBottom:70}}>
                    <div className="owner"><img className="wal" src="https://cdn-icons-png.flaticon.com/128/6699/6699308.png" alt=""/>&nbsp;Crypto Wallet</div>
                    <br/>
                    <div className="owner"  style={{color:"white"}}>Contract Owner:{"\t"+owner}</div>
                    <br/>
                    <div className="owner" style={{color:"white"}}>Current Account:{"\t"+account}</div>
                </div>
                <Box display="flex" color={"white"} marginTop={20} fontSize={30} marginLeft={50} alignItems={"center"} justifyContent={"center"}>ADMIN DASHBOARD</Box>
                ...
                <Box m={1}>
                    <Grid container justify="center" spacing={3}>
                        <Grid item>
                            <Chip label="Add Hospital" style={{backgroundColor:"#043578"}} onClick={async ()=>{
                                await this.setState({viewH:false,addview:true,load:false});
                            }}></Chip>
                        </Grid>
                        <Grid item>
                            <Chip label="View Hospital" style={{backgroundColor:"#043578"}} onClick={async ()=>{
