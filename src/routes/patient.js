    ...
    render(){
        return(
            ...
            <div className="contract-details">
                    <div className="owner"><img className="wal" src="https://cdn-icons-png.flaticon.com/128/6699/6699308.png" alt=""/>&nbsp;Crypto Wallet</div>
                    <br/>
                    <div className="owner"  style={{color:"white"}}>Contract Owner:{"\t"+this.state.owner}</div>
                    <br/>
                    <div className="owner" style={{color:"white"}}>Current Account:{"\t"+this.state.account}</div>
                </div>
                {/* <Box m={1}><Card>Contract Owner:{"\t"+this.state.owner}</Card></Box>
                <Box m={1}><Card>Current Account:{"\t"+this.state.account}</Card></Box> */}
                <Box display="flex" color={"white"} marginTop={20} fontSize={30} marginLeft={50} alignItems={"center"} justifyContent={"center"}>PATIENT DASHBOARD</Box>
                <Box m={3}>
                    <Grid container justify="center" spacing={3}>
                        <Grid item>
                            <Chip style={{backgroundColor:"#043578"}} label="My Account" onClick={async ()=>{
                                await this.getPatientInfo();
                                await this.setState({load:false,orecord:false,arecord:false,rview:false,oview:false,pview:true});
                            }}></Chip>
                        </Grid>
                        <Grid item >
                            <Chip style={{backgroundColor:"#043578"}} label="My Records" onClick={async ()=>{
                                await this.getPatientRecords();
                            }}></Chip>
                        </Grid>
                        <Grid item >
                            <Chip style={{backgroundColor:"#043578"}} label="Add Record" onClick={
                                async()=>{this.setState({pview:false,orecord:false,rview:false,oview:false,gview:false,load:false,arecord:true});}
                            }></Chip>
                        </Grid>
                        <Grid item >
                            <Chip style={{backgroundColor:"#043578"}} label="Grant Permissions" onClick={async ()=>{
                                await this.setState({pview:false,rview:false,oview:false,load:false,rkview:false,orecord:false,arecord:false,gview:true});
                            }}></Chip>
                        </Grid>
                        <Grid item>
                            <Chip label="Revoke Permissions" style={{backgroundColor:"#043578"}} onClick={async ()=>{
                                await this.setState({pview:false,rview:false,oview:false,load:false,arecord:false,gview:false,orecord:false,rkview:true});
                            }}></Chip>
                        </Grid>
                        <Grid item >
                            <Chip style={{backgroundColor:"#043578"}} label="View Other Patient Info" onClick={async ()=>{
                                await this.setState({pview:false,rview:false,load:false,rkview:false,arecord:false,gview:false,orecord:false,oview:true});
                            }}></Chip>
                        </Grid>
                        <Grid item >
                            <Chip style={{backgroundColor:"#043578"}} label="Upload Other Patient Records" onClick={async ()=>{
