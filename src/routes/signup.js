    ...
    render(){
        return(
            ...
            <div className="contract-details">
                ...
                <Box display="flex" color={"white"} marginTop={20} fontSize={30} marginLeft={50} alignItems={"center"} justifyContent={"center"}>SIGNUP</Box>
            {/* <Box m={1}>
                <Box m={1}><Card>Contract Owner:{"\t"+this.state.owner}</Card></Box>
                <Box m={1}><Card>Current Account:{"\t"+this.state.account}</Card></Box>
            </Box> */}
            <Box display="flex" marginTop={20} marginLeft={10} alignItems={"center"} justifyContent={"center"}>
            <Typography style={{color:"yellow"}}>{"Already Registered User?"}</Typography>
             <Box ml={2} mr={2}>
