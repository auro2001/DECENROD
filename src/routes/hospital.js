    ...
    render(){
        return(
            ...
            <div className="contract-details">
                ...
                <Box display="flex" color={"white"} marginTop={20} fontSize={30} marginLeft={50} alignItems={"center"} justifyContent={"center"}>HOSPITAL DASHBOARD</Box>
                <Box m={3}>
                    <Grid container justify="center" spacing={3}>
                    <Grid item >
                            <Chip style={{backgroundColor:"#043578"}} label="Hospital Information" onClick={async ()=>{
                                await this.setState({pview:false,rview:false,oview:false,load:false,arecord:false,orecord:false,viewH:true});
                            }}></Chip>
                        </Grid>
                    <Grid item >
                            <Chip style={{backgroundColor:"#043578"}} label="Add Patient Record" onClick={async ()=>{
                                await this.setState({pview:false,rview:false,oview:false,load:false,arecord:false,orecord:true,viewH:false});
                            }}></Chip>
                        </Grid>
                        <Grid item >
                            <Chip style={{backgroundColor:"#043578"}} label="View Patient Record" onClick={async ()=>{
